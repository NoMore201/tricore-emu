...
constexpr u32 pms_monfilt_reset_value = 0; // TODO: change according manual
...
constexpr u32 pms_monbiststat_reset_value = 0; // TODO: change according manual
constexpr u32 pms_monbistctrl_reset_value = 0; // TODO: change according manual
...
constexpr u32 pms_memory_size = 0; // TODO: update according manual;
...
void Tricore::Pms::read(std::byte *buffer_out, u32 address, usize length) {
    ...
    case reg_pms_id_offset: {
            ...
            const auto *range_start = reinterpret_cast<std::byte *>(&m_pms_id);
