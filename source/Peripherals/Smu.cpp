...
constexpr u32 smu_memory_end_address = smu_memory_start_address + smu_memory_size;

constexpr u32 reg_smu_clc_address = 0xf0036800;
constexpr u32 reg_smu_clc_offset = reg_smu_clc_address - smu_memory_start_address;
...
constexpr u32 reg_smu_cmd_offset = reg_smu_cmd_address - smu_memory_start_address;
constexpr u32 reg_smu_sts_address = 0xf0036824;
constexpr u32 reg_smu_sts_offset = reg_smu_sts_address - smu_memory_start_address;
constexpr u32 reg_smu_fsp_address = 0xf0036828;
constexpr u32 reg_smu_fsp_offset = reg_smu_fsp_address - smu_memory_start_address;
constexpr u32 reg_smu_agc_address = 0xf003682c;
constexpr u32 reg_smu_agc_offset = reg_smu_agc_address - smu_memory_start_address;
constexpr u32 reg_smu_rtc_address = 0xf0036830;
constexpr u32 reg_smu_rtc_offset = reg_smu_rtc_address - smu_memory_start_address;
constexpr u32 reg_smu_keys_address = 0xf0036834;
constexpr u32 reg_smu_keys_offset = reg_smu_keys_address - smu_memory_start_address;
constexpr u32 reg_smu_dbg_address = 0xf0036838;
constexpr u32 reg_smu_dbg_offset = reg_smu_dbg_address - smu_memory_start_address;
constexpr u32 reg_smu_pctl_address = 0xf003683c;
constexpr u32 reg_smu_pctl_offset = reg_smu_pctl_address - smu_memory_start_address;
constexpr u32 reg_smu_afcnt_address = 0xf0036840;
constexpr u32 reg_smu_afcnt_offset = reg_smu_afcnt_address - smu_memory_start_address;
constexpr u32 reg_smu_rtac00_address = 0xf0036860;
constexpr u32 reg_smu_rtac00_offset = reg_smu_rtac00_address - smu_memory_start_address;
constexpr u32 reg_smu_rtac01_address = 0xf0036864;
constexpr u32 reg_smu_rtac01_offset = reg_smu_rtac01_address - smu_memory_start_address;
constexpr u32 reg_smu_rtac10_address = 0xf0036868;
constexpr u32 reg_smu_rtac10_offset = reg_smu_rtac10_address - smu_memory_start_address;
constexpr u32 reg_smu_rtac11_address = 0xf003686c;
constexpr u32 reg_smu_rtac11_offset = reg_smu_rtac11_address - smu_memory_start_address;
constexpr u32 reg_smu_aex_address = 0xf0036870;
constexpr u32 reg_smu_aex_offset = reg_smu_aex_address - smu_memory_start_address;
constexpr u32 reg_smu_aexclr_address = 0xf0036874;
constexpr u32 reg_smu_aexclr_offset = reg_smu_aexclr_address - smu_memory_start_address;
constexpr u32 reg_smu_rmctl_address = 0xf0036b00;
constexpr u32 reg_smu_rmctl_offset = reg_smu_rmctl_address - smu_memory_start_address;
constexpr u32 reg_smu_rmef_address = 0xf0036b04;
constexpr u32 reg_smu_rmef_offset = reg_smu_rmef_address - smu_memory_start_address;
constexpr u32 reg_smu_rmsts_address = 0xf0036b08;
constexpr u32 reg_smu_rmsts_offset = reg_smu_rmsts_address - smu_memory_start_address;
constexpr u32 reg_smu_ocs_address = 0xf0036fe8;
constexpr u32 reg_smu_ocs_offset = reg_smu_ocs_address - smu_memory_start_address;
constexpr u32 reg_smu_accen1_address = 0xf0036ff8;
constexpr u32 reg_smu_accen1_offset = reg_smu_accen1_address - smu_memory_start_address;
constexpr u32 reg_smu_accen0_address = 0xf0036ffc;
constexpr u32 reg_smu_accen0_offset = reg_smu_accen0_address - smu_memory_start_address;

} // anonymous namespace


Tricore::Smu::Smu()
    : m_smu_clc(smu_clc_reset_value)
    , m_smu_id(smu_id_reset_value)
    , m_smu_cmd(smu_cmd_reset_value)
    , m_smu_sts(smu_sts_reset_value)
    , m_smu_fsp(smu_fsp_reset_value)
    , m_smu_agc(smu_agc_reset_value)
    , m_smu_rtc(smu_rtc_reset_value)
    , m_smu_keys(smu_keys_reset_value)
    , m_smu_dbg(smu_dbg_reset_value)
    , m_smu_pctl(smu_pctl_reset_value)
    , m_smu_afcnt(smu_afcnt_reset_value)
    , m_smu_rtac00(smu_rtac00_reset_value)
    , m_smu_rtac01(smu_rtac01_reset_value)
    , m_smu_rtac10(smu_rtac10_reset_value)
    , m_smu_rtac11(smu_rtac11_reset_value)
    , m_smu_aex(smu_aex_reset_value)
    , m_smu_aexclr(smu_aexclr_reset_value)
    , m_smu_rmctl(smu_rmctl_reset_value)
    , m_smu_rmef(smu_rmef_reset_value)
    , m_smu_rmsts(smu_rmsts_reset_value)
    , m_smu_ocs(smu_ocs_reset_value)
    , m_smu_accen1(smu_accen1_reset_value)
    , m_smu_accen0(smu_accen0_reset_value)
{}

// NOLINTBEGIN(cppcoreguidelines-pro-type-reinterpret-cast, cppcoreguidelines-pro-bounds-pointer-arithmetic)

void Tricore::Smu::read(std::byte *buffer_out, u32 address, usize length) {
...
void Tricore::Smu::write(const std::byte *buffer_in, u32 address,
                         usize length) {
    const u32 offset = address - smu_memory_start_address;
    switch (offset) {
    case reg_smu_clc_offset: {
