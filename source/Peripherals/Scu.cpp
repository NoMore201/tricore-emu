...
constexpr u32 scu_id_reset_value = 0; // TODO: change according manual
constexpr u32 scu_osccon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_syspllstat_reset_value = 0; // TODO: change according manual
constexpr u32 scu_syspllcon0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_syspllcon1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_syspllcon2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_perpllstat_reset_value = 0; // TODO: change according manual
constexpr u32 scu_perpllcon0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_perpllcon1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_fdr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_extcon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon3_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon4_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon5_reset_value = 0; // TODO: change according manual
constexpr u32 scu_rststat_reset_value = 0; // TODO: change according manual
constexpr u32 scu_rstcon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_arstdis_reset_value = 0; // TODO: change according manual
constexpr u32 scu_swrstcon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_rstcon2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_rstcon3_reset_value = 0; // TODO: change according manual
constexpr u32 scu_esrocfg_reset_value = 0; // TODO: change according manual
constexpr u32 scu_syscon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon6_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ccucon7_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pdr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_iocr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_out_reset_value = 0; // TODO: change according manual
constexpr u32 scu_omr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_in_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ststat_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stcon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmcsr0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmcsr1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmcsr2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmcsr3_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmcsr4_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmcsr5_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmstat0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmswcr1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_emsr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_emssw_reset_value = 0; // TODO: change according manual
...
constexpr u32 scu_trapdis1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_trapstat_reset_value = 0; // TODO: change according manual
constexpr u32 scu_trapset_reset_value = 0; // TODO: change according manual
constexpr u32 scu_trapclr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_trapdis0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lclcon0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lclcon1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lcltest_reset_value = 0; // TODO: change according manual
constexpr u32 scu_chipid_reset_value = 0; // TODO: change according manual
constexpr u32 scu_manid_reset_value = 0; // TODO: change according manual
constexpr u32 scu_swapctrl_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lbistctrl0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lbistctrl1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lbistctrl2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_lbistctrl3_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stmem1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stmem2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pdisc_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmtrcsr0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmtrcsr1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmtrcsr2_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pmtrcsr3_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stmem3_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stmem4_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stmem5_reset_value = 0; // TODO: change according manual
constexpr u32 scu_stmem6_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ovcenable_reset_value = 0; // TODO: change according manual
constexpr u32 scu_ovccon_reset_value = 0; // TODO: change according manual
constexpr u32 scu_eifilt_reset_value = 0; // TODO: change according manual
constexpr u32 scu_eifr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_fmr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_pdrr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_eicon0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_eicon1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_eisr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_wdts_con0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_wdts_con1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_wdts_sr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_seicon0_reset_value = 0; // TODO: change according manual
constexpr u32 scu_seicon1_reset_value = 0; // TODO: change according manual
constexpr u32 scu_seisr_reset_value = 0; // TODO: change according manual
constexpr u32 scu_accen11_reset_value = 0; // TODO: change according manual
constexpr u32 scu_accen10_reset_value = 0; // TODO: change according manual
constexpr u32 scu_accen01_reset_value = 0; // TODO: change according manual
constexpr u32 scu_accen00_reset_value = 0; // TODO: change according manual

constexpr u32 scu_memory_start_address = 0xf0036000U;
constexpr u32 scu_memory_size = 0; // TODO: update according manual;
