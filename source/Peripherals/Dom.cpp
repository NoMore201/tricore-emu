...
void Tricore::Dom::read(std::byte *buffer_out, u32 address, usize length) {
    ...
    case reg_dom0_id_offset: {
            ...
            const auto *range_start = reinterpret_cast<std::byte *>(&m_dom0_id);
...
void Tricore::Dom::write(const std::byte *buffer_in, u32 address,
                         usize length) {
    const u32 offset = address - dom_memory_start_address;
    switch (offset) {
    case reg_dom0_id_offset: {
