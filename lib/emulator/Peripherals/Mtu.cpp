...
void Tricore::Peripherals::Mtu::read(std::byte *buffer_out, u32 address, usize length) {
    ...
    case reg_mtu_clc_offset: {
            ...
            const auto *range_start = reinterpret_cast<std::byte *>(&m_mtu_clc);
