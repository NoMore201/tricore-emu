#ifndef TRICORE_EMU_BUSOPS_HPP
#define TRICORE_EMU_BUSOPS_HPP
...
public:
    virtual ~BusOps() = default;

    // read/write access

    virtual void read(Span<byte> buffer_out, u32 address) = 0;

    virtual void write(Span<const byte> buffer_in, u32 address) = 0;
